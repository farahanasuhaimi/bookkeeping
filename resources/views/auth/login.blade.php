        ...
        <div class="flex-1 flex flex-col justify-center px-6 sm:px-12 xl:px-32 py-12">
            ...
            <form method="POST" action="{{ route('login.store') }}" class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-2">
                    <div class="flex justify-between items-center">
                        ...
                        <a class="text-xs font-semibold text-primary hover:text-green-400 transition-colors"
                ...
                <div class="flex items-center gap-3 py-1">
                    <input
                        class="h-5 w-5 rounded border-border-color dark:border-gray-600 border-2 bg-transparent text-primary checked:bg-primary checked:border-primary checkbox-tick-svg focus:ring-0 focus:ring-offset-0 focus:outline-none transition-colors cursor-pointer"
                        id="remember-me" type="checkbox" name="remember" />
                    <label
                        class="text-text-main dark:text-gray-300 text-sm font-normal leading-normal cursor-pointer select-none"
                        for="remember-me">Remember me for 30 days</label>
                </div>
                <!-- Submit Button -->
                <button
                ...
                <div class="relative flex py-2 items-center">
                    ...
                    <span
                        class="flex-shrink-0 mx-4 text-text-muted dark:text-gray-500 text-xs uppercase tracking-wider font-semibold">Or
                        continue with</span>
                    <div class="flex-grow border-t border-border-color dark:border-gray-700"></div>
                </div>
                <!-- Social Login -->
                <div class="grid grid-cols-2 gap-4">
                    <button
                        class="flex items-center justify-center gap-2 h-11 rounded-lg border border-border-color dark:border-gray-600 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                        type="button">
            ...
            <div class="mt-8 text-center">
                <p class="text-text-muted dark:text-gray-500 text-sm">
                    New to TaxKeep?
                    <a class="text-primary font-semibold hover:underline" href="{{ route('register') }}">Start
                        your free trial</a>
                </p>
            </div>
        </div>
