...
<style>
.checkbox-tick-svg {
    background-image: url("{{ asset('images/checkbox.svg') }}")
}
</style>
        ...
        <div class="flex-1 flex flex-col justify-center px-6 sm:px-12 xl:px-32 py-12">
            ...
            <div class="mb-8 border-b border-border-color dark:border-gray-700">
                <div class="flex gap-8">
                    <a href="{{ route('login') }}" class="group flex flex-col items-center justify-center border-b-[3px] border-b-text-main dark:border-b-primary pb-[13px] pt-4 px-2 outline-none focus:outline-none">
            ...
            <form action="{{ route('login.store') }}" method="POST" class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-2">
                    <div class="flex justify-between items-center">
                        ...
                        <a class="text-xs font-semibold text-primary hover:text-green-400 transition-colors" href="#">Forgot Password?</a>
                    </div>
                ...
                <div class="flex items-center gap-3 py-1">
                    <input class="h-5 w-5 rounded border-border-color dark:border-gray-600 border-2 bg-transparent text-primary checked:bg-primary checked:border-primary checkbox-tick-svg focus:ring-0 focus:ring-offset-0 focus:outline-none transition-colors cursor-pointer" id="remember-me" type="checkbox" name="remember"/>
